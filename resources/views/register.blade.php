          ...
          <div class="card-body p-5">
            <div class="row mb-2">
              <div class="col-12 text-center">
                <img src="{{ 'assets/' }}images/logo_BLKMjabar.png" alt="logo" width="80px" class="mb-3">
            ...
            <form id="formRegister" action="{{ 'register' }}" method="post" enctype="multipart/form-data">
              ...
              <div class="row">
                <div class="col-lg-6">
                  <div class="form-group">
                    <label for="foto_ktp" class="font-weight-bold">Foto KTP <small class="text-danger">(Max:
                        2MB)</small></label>
                ...
                <div class="col-lg-6">
                  <div class="form-group">
                    <label for="pas_foto" class="font-weight-bold">Pas Foto 3x4 <small class="text-danger">(Max:
                        2MB)</small></label>
                ...
                <div class="col-12">
                  <div class="form-group form-check">
                    ...
                    <label class="form-check-label" id="cek_setuju">
                      Dengan ini, saya menyetujui <a href="#">Syarat dan Ketentuan</a> dan <a href="#">Kebijakan
              ...
              <div class="row">
                <div class="col-12">
                  <button type="submit" id="btnRegister" class="btn btn-primary btn-block"
                    style="border-radius: 0px; padding: 8px;">Daftar</button>
                </div>
              </div>
            </form>
            <div class="row pt-4">
