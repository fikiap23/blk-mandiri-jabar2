                    ...
                    <ul class="navbar-nav ml-auto text-center">
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu" aria-labelledby="navbarDropdown02">
                                <li><a class="dropdown-item" href="{{ url('/strukturOrganisasi') }}">Struktur
                                        Organisasi</a></li>
                                <li><a class="dropdown-item" href="{{ url('/daftarKejuruan') }}">Daftar Kejuruan</a>
                                </li>
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu" aria-labelledby="navbarDropdown02">
                                ...
                                <li><a class="dropdown-item" href="{{ url('/kebijakanPrivasi') }}">Kebijakan
                                        Privasi</a></li>
                            </ul>
                        </li>
                        <li class="nav-item ">
