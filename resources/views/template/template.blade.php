            ...
            <nav class="navbar navbar-expand-lg navbar-light px-0">
                ...
                <div class="collapse navbar-collapse" id="navigation">
                    <ul class="navbar-nav ml-auto text-center">
                        ...
                        <li
                            class="nav-item dropdown {{ $active == 'login' || $active == 'register' ? 'active' : '' }}">
                            <a class="nav-link dropdown-toggle" href="#!" id="navbarDropdown02" role="button"
                                data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
            ...
            <div class="container">
                <div class="row justify-content-around">
                    <div class="col-lg-4 col-md-6 mb-5 mb-lg-0">
                        <h3>About</h3>
                        <p>Balai Latihan Kerja Mandiri (BLK Mandiri) Disnakertrans Jawa Barat adalah lembaga yang
                            berkomitmen untuk meningkatkan kualitas sumber daya manusia melalui program pelatihan
                            keterampilan praktis.</p>
                    </div>
                    <!-- End of .col-sm-3 -->
