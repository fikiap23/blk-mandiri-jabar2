            ...
            <div class="col">
                <form action="/dashboard/artikel/{{ $artikel->slug }}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="card-body">
                        <div class="col-lg-6 mb-3">
                            ...
                            <input type="text" class="form-control @error('judul') is-invalid @enderror" placeholder=""
                                name="judul" id="judul" value="{{ old('judul', $artikel->judul) }}" required
                                autofocus>
                            @error('judul')
                        ...
                        <div class="col-lg-6 mb-3">
                            ...
                            <input type="text" class="form-control @error('slug') is-invalid @enderror" placeholder=""
                                name="slug" id="slug" value="{{ old('slug', $artikel->slug) }}" readonly>
                            @error('slug')
                                <div class="invalid-feedback">
                                    Slug harus diisi
                                </div>
                        ...
                        <div class="col-lg-6 mb-3">
                            ...
                            <input type="text" class="form-control" placeholder="" name="sumber_gambar"
                                id="sumber_gambar" value="{{ old('sumber_gambar', $artikel->sumber_gambar) }}">
                        </div>
                        <div class="mb-3">
                    ...
                    <div class="card-footer d-grid d-lg-flex justify-content-lg-end">
                        <button type="submit" class="btn btn-primary"> <i class="fa-solid fa-pen-to-square"></i> Edit
                        </button>
                    </div>
                </form>
            </div>
